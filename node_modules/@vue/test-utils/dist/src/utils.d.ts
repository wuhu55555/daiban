...
import type { Component, ComponentOptions, ComponentPublicInstance, ConcreteComponent, Directive, FunctionalComponent } from 'vue';
...
export declare function isFunctionalComponent(component: unknown): component is FunctionalComponent<any>;
...
export declare function hasOwnProperty<O extends object, P extends PropertyKey>(obj: O, prop: P): obj is O & Record<P, unknown>;
export declare function isNotNullOrUndefined<T extends object>(obj: T | null | undefined): obj is T;
